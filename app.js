...
function startGame() {
    ...
    if (player1Name === "" || player2Name === "") {
        ...
        document.getElementById("output").innerHTML = `<div class="alert alert-danger">Please Enter Names</div>`
...
function game(x) {
    ...
    // document.getElementById(b1).classList.add("bg-danger")
    ...
    if (!winner() && checkAllFill()) {
        ...
        dCount++
        stat()
        document.getElementById("output").innerHTML = "<div class='alert alert-primary'>Match Drawn</div>"
        setTimeout(function () {
            document.getElementById("output").innerHTML = ""
        }, 3000)
        setTimeout(function () {
...
function winner() {
    return (
        ...
        checkWinner("b9", "b6", "b3", "bg-danger") ||
        checkWinner("b5", "b7", "b3", "bg-danger") ||
        ...
        checkWinner("b9", "b6", "b3", "bg-success") ||
        checkWinner("b5", "b7", "b3", "bg-success") ||
...
function checkWinner(id1, id2, id3, color) {
    ...
    if (isBox1 && isBox2 && isBox3) {
        ...
        document.getElementById("output").innerHTML = `<div class="alert alert-success">${color === "bg-danger" ? "Player1" : "Player 2"} Won</div>`
        setTimeout(function () {
            document.getElementById("output").innerHTML = ""
        }, 3000)
        setTimeout(function () {
